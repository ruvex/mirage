...
private slots:
    ...
    QString BuyMIRAGE(QString OrderType, double Quantity, double Rate);
    QString SellMIRAGE(QString OrderType, double Quantity, double Rate);
