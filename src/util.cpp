...
int nAnonymizeMIRAGEAmount = 500000;
...
string FormatMoney(int64_t n, bool fPlus)
{
    ...
    string str = strprintf(COIN_FMT, quotient, remainder);
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\MIRAGE
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\MIRAGE
    // Mac: ~/Library/Application Support/MIRAGE
    // Unix: ~/.MIRAGE
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "MIRAGE";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "MIRAGE.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "MIRAGEd.pid"));
