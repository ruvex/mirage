...
static const int64_t COIN = 100;
static const int64_t CENT = 1;
static const char COIN_FMT[] = "%d.%02d";
...
extern int nAnonymizeMIRAGEAmount;
...
{
    std::string s = strprintf("MIRAGE-%s", name);
